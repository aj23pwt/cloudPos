...
public interface IPosDishcardDao extends IBaseDao
{
  ...
  public String updateKitchenMsg(Long hotelId, Long hotelGroupId, String accnt,String type,String mode,Integer id,String oldTableNo, String newTableNo,String station,String empno,String kitmsg);
}