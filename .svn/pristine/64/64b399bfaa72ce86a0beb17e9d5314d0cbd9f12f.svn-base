...
public class PosMaster  extends OperationInfo{
	...
	private Integer lastrnum;
	private Integer lastpnum;
	...
	public String getExttableno() {
		return exttableno;
	}
	public void setExttableno(String exttableno) {
		this.exttableno = exttableno;
	}
	...
	public Integer getLastrnum() {
		return lastrnum;
	}
	public void setLastrnum(Integer lastrnum) {
		this.lastrnum = lastrnum;
	}
	public Integer getLastpnum() {
		return lastpnum;
	}
	public void setLastpnum(Integer lastpnum) {
		this.lastpnum = lastpnum;
	}
