...
public List<PosSortAll> findPosSortAll(Long hotelGroupId, Long hotelId,
	...
	public List<PosSortAll> getPosSortAllList(Long hotelGroupId, Long hotelId) {
		String sql = "SELECT p2.descript des2,p1.code code,p1.descript des1 "
				+ " FROM pos_sort_all p1,(SELECT code,descript FROM code_base WHERE hotel_group_id='"+hotelGroupId+"' AND hotel_id='"+hotelId+"' AND parent_code='pos_note') p2 "
				+ " WHERE hotel_group_id='"+hotelGroupId+"' AND hotel_id='"+hotelId+"' AND p1.plu_code = p2.code";
