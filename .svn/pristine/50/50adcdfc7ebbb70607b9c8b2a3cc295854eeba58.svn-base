...
public class PosAccount extends OperationInfo {
	...
	public String getDtlAccnt() {
		return dtlAccnt;
	}
	public void setDtlAccnt(String dtlAccnt) {
		this.dtlAccnt = dtlAccnt;
	}
