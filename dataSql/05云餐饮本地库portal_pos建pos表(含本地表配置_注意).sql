...
CREATE TABLE `pos_pccode` (
  ...
  `dec_mode` char(1) DEFAULT '1' COMMENT '四舍五入OR全部进（抹零方式）',
...
CREATE TABLE IF NOT EXISTS `pos_store_article` (
  ...
  `price` decimal(12,2) DEFAULT '0.00' COMMENT '参考进价',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='餐饮物品表';
...
CREATE TABLE IF NOT EXISTS `pos_store_bar` (
  ...
  `pccodes` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pos_store_detail` (
  ...
  `packing_size` varchar(20) DEFAULT NULL,
  `price` decimal(12,0) DEFAULT '2',
  `unit` char(4) DEFAULT NULL,
  `number` int(11) DEFAULT NULL,
  `amount` decimal(12,0) DEFAULT '2',
  `create_user` varchar(20) DEFAULT NULL,
  `create_datetime` datetime DEFAULT NULL,
  `modify_user` varchar(20) DEFAULT NULL,
  `modify_datetime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pos_store_master` (
  ...
  `type` char(2) NOT NULL COMMENT '账单类型（入库，销售，盘点，结转，等）',
  `source_code` varchar(20) DEFAULT NULL COMMENT '出货库',
  `target_code` varchar(20) DEFAULT NULL COMMENT '目标库或销售点',
  `date` datetime DEFAULT NULL,
...
-- 请注意修改code_cache hotel_id
INSERT INTO `code_cache` VALUES ('9', '2', '1', 'com.greencloud.entity.SysOption', 'ADMIN', '2013-08-14 22:57:54', 'admin', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findSysOption');
INSERT INTO `code_cache` VALUES ('9', '2', '2', 'com.greencloud.entity.CodeBase', 'ADMIN', '2013-08-14 22:57:54', 'admin', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findCodeBase');
INSERT INTO `code_cache` VALUES ('9', '2', '3', 'com.greencloud.entity.PosIp', 'ADMIN', '2013-08-14 22:57:54', 'admin', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findPosIp');
INSERT INTO `code_cache` VALUES ('9', '2', '4', 'com.greencloud.entity.PosSortAll', 'ADMIN', '2013-08-14 22:57:54', 'admin', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findPosSortAll');
INSERT INTO `code_cache` VALUES ('9', '2', '5', 'com.greencloud.entity.PosPluAll', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findPosPluAll');
INSERT INTO `code_cache` VALUES ('9', '2', '6', 'com.greencloud.entity.PosCondst', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findPosCondst');
INSERT INTO `code_cache` VALUES ('9', '2', '7', 'com.greencloud.entity.PosConddtl', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findPosConddtl');
INSERT INTO `code_cache` VALUES ('9', '2', '8', 'com.greencloud.entity.CodeTransaction', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-09-06 12:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findCodeTransaction');
INSERT INTO `code_cache` VALUES ('9', '2', '9', 'com.greencloud.entity.PosPccodeNote', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-12-05 11:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findPosPccodeNote');
INSERT INTO `code_cache` VALUES ('9', '2', '10', 'com.greencloud.entity.UserPosAuth', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-12-05 11:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findUserPosAuth');
INSERT INTO `code_cache` VALUES ('9', '2', '11', 'com.greencloud.entity.UserPosAuthUserAuth', 'ADMIN', '2013-08-14 22:57:54', 'ADMIN', '2015-12-05 11:11:11', 'com.greencloud.facade.CodeCacheFacadeService', 'findUserPosAuthUserAuth');
-- 请注意修改pos_table_sync hotel_id

INSERT INTO `pos_table_sync` VALUES ('1', '2', '9', 'App', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2015-09-12 22:49:52', 'ADMIN', '2015-09-12 22:49:58');
INSERT INTO `pos_table_sync` VALUES ('11', '2', '9', 'BillDefine', 'PMS', 'POS', 'HOTEL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('13', '2', '9', 'BillSceneLink', 'PMS', 'POS', 'HOTEL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('15', '2', '9', 'BillTemplate', 'PMS', 'POS', 'HOTEL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('16', '2', '9', 'BizMonth', 'PMS', 'POS', 'TIME', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('19', '2', '9', 'CodeBankcardLink', 'PMS', 'POS', 'TIME', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('20', '2', '9', 'CodeBase', 'PMS', 'POS', 'TIME', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('26', '2', '9', 'CodeCurrency', 'PMS', 'POS', 'TIME', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('34', '2', '9', 'CodeTransaction', 'PMS', 'POS', 'TIME', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('36', '2', '9', 'Hotel', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('37', '2', '9', 'HotelAroundTraffic', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('38', '2', '9', 'HotelDef', 'PMS', 'POS', 'F', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('39', '2', '9', 'HotelGroup', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('40', '2', '9', 'HotelPromotion', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('41', '2', '9', 'HotelServiceConfig', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('42', '2', '9', 'HotelSpecialPrompt', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('110', '2', '9', 'ReportCategory', 'PMS', 'POS', 'HOTEL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('111', '2', '9', 'ReportCenter', 'PMS', 'POS', 'HOTEL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('117', '2', '9', 'SalesMan', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('118', '2', '9', 'SalesManBusiness', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('119', '2', '9', 'Sso', 'PMS', 'POS', 'ALL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('132', '2', '9', 'SysOption', 'PMS', 'POS', 'TIME', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('138', '2', '9', 'User', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('139', '2', '9', 'UserAuth', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('140', '2', '9', 'UserAuthBuilding', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('141', '2', '9', 'UserAuthCache', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('143', '2', '9', 'UserAuthCfgDeptRole', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('144', '2', '9', 'UserAuthCfgRoleAuth', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('145', '2', '9', 'UserAuthCfgRoleCard', 'PMS', 'POS', 'F', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('146', '2', '9', 'UserAuthCfgRoleRep', 'PMS', 'POS', 'HOTEL', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('147', '2', '9', 'UserAuthCfgUserRole', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('148', '2', '9', 'UserAuthTemp', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('149', '2', '9', 'UserAuthTempUser', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('150', '2', '9', 'UserDept', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('151', '2', '9', 'UserHabitsBase', 'PMS', 'POS', 'F', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('152', '2', '9', 'UserNote', 'PMS', 'POS', 'F', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('153', '2', '9', 'UserPwd', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_table_sync` VALUES ('154', '2', '9', 'UserRole', 'PMS', 'POS', 'GROUP', '', 'F', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
-- 请注意修改pos_ip hotel_id
INSERT INTO `pos_ip` VALUES ('2', '9', '3', 'POS', '餐饮服务器', 'http://192.168.2.100:8080/pos', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
INSERT INTO `pos_ip` VALUES ('2', '9', '4', 'PMS', '云服务器', 'http://192.168.2.100:8090/ipms', 'ADMIN', '2011-11-11 11:11:11', 'ADMIN', '2011-11-11 11:11:11');
